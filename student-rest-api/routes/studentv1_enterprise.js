...
const AuthenticationController = require('../controllers/V1/Student_Enterprise/Authentication.controller');
const DashboardController = require('../controllers/V1/Student_Enterprise/Dashboard.controller');
const PollController = require('../controllers/V1/Student_Enterprise/Polls.controller');
const TestController = require('../controllers/V1/Student_Enterprise/Test.controller');
const FeedbackController = require('../controllers/V1/Student_Enterprise/Feedback.controller');
const ReviewController = require('../controllers/V1/Student_Enterprise/Review.controller');
const PurchaseController = require('../controllers/V1/Student_Enterprise/Purchase.controller');
const ForumController = require('../controllers/V1/Student_Enterprise/Forum.controller');
const ForumDiscussion = require('../controllers/V1/Student_Enterprise/Forum_Discussion.controller');
const SupportRequestController = require('../controllers/V1/Student_Enterprise/SupportRequest.controller');
const LiveClassesController = require('../controllers/V1/Student_Enterprise/LiveClasses.controller');
const LogController = require('../controllers/V1/Student_Enterprise/Log.controller');
const NewsController = require('../controllers/V1/Student_Enterprise/News.controller');
const TestBundleController = require('../controllers/V1/Student_Enterprise/TestBundle.controller');
const NotificationController 	= require('../controllers/V1/Student_Enterprise/Notification.controller');
const TutorController 	= require('../controllers/V1/Student_Enterprise/Tutor.controller');
...
router.get('/', function (req, res, next) {
  res.json({ status: true, message: "This is Company Student Enterprise Rest api.", data: { "version_number": "v1.0.0" } })
});
...
router.post('/loginWithPhone',           AuthenticationController.loginWithPhone);
