...
module.exports.getStudent = async function (studentId) {
    ...
    [err, student] = await to(TOA_student.findOne({
        ...
        attributes: ['id', ['education_type_id', 'educationType'], 'image', ['first_name', 'firstName'], ['last_name', 'lastName'], 'phone', 'email', 'pincode', 'gender'],
        include: [
            {
                    ...
                    include:[
                        {
                            ...
                            as: 'account',
                            where: { status: 0, delete: 0 },
                            attributes: [['account_id', 'id'], ['account_title', 'title'] , ['account_image', 'image'] , ['is_marketplace_enable' , 'is_MarketplaceEnable'], 'accessLevel'],
                        },
                    ]
                }]
            },
