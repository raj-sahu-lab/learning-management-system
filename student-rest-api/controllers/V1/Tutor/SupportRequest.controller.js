const supportRequestService = require('../../../services/V1/Tutor/SupportRequest.service');
...
module.exports.getSupportRequestList = async function (req, res) {
    ...
    [err, supportRequestList] = await to(supportRequestService.getSupportRequestList(req.user.id));
