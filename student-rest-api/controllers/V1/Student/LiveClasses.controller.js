const liveClassesService = require('../../../services/V1/Student/LiveClass.service');
...
module.exports.getLiveClassKey = async function (req, res) {
    ...
    if (!liveClassKey) {
        ...
        liveClassKeyJson.androidSecret = CryptoJS.AES.decrypt(liveClassKeyJson.androidSecret, CONFIG.CRYPTOJS_ENCRYPTION_KEY).toString(CryptoJS.enc.Utf8);
        liveClassKeyJson.androidKey = CryptoJS.AES.decrypt(liveClassKeyJson.androidKey, CONFIG.CRYPTOJS_ENCRYPTION_KEY).toString(CryptoJS.enc.Utf8);
