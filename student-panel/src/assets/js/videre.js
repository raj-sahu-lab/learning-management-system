				...
				template = $(
								'<div id="videoDiv" class="vid-html5">'+
									...
									'<div class="vid-toggle-layer">'+
										'<div id="loading" class="d-none loading-progress">'+
											'<img class="w-100" src="./assets/img/icons/loading-gif.gif">'+
										'</div>'+
											...
											'<div class="vid-controls-contents align-center">'+
												...
												'<div class="flex">'+
													...
													'<div style="margin-left:5px;margin-top:4px" class="flex">'+
														'<span class="vid-current-time">00:00</span>'+
														'<span> / </span>'+
														'<span class="vid-duration">00:00</span>'+
													'</div>'+
												'</div>'+
