...
export class PaymentGateWayComponent implements OnInit, OnDestroy {
  ...
  constructor(private stripeFactory: StripeFactoryService, public helperService: HelperService, private toastr: ToastrService, public paymentGateWayService: PaymentGateWayService, private cd: ChangeDetectorRef) {
