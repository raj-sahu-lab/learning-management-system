...
export class TaketestComponent implements OnInit, OnDestroy {
  ...
  constructor(public redirectionService: RedirectionService, public router: Router,private sanitizer: DomSanitizer,private route: ActivatedRoute, private toastr: ToastrService, public testDetailsService: TestDetailsService, private location: Location) {
