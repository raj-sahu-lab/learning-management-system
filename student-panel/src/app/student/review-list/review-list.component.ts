...
export class ReviewListComponent implements OnInit, OnDestroy {
  ...
  constructor(public reviewService : ReviewAndRatingService, public router : Router,protected serviceDashboard: DashboardApiHelper, private toastr: ToastrService, public helperService: HelperService, private location: Location) { }
