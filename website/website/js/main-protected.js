...
(function ($) {
    ...
    * ---------------------------*/
    ...
    //
    jQuery(".js-message-popup-partner").on('click', function () {
        CRUMINA.toggleNav();
        setTimeout(function () { $('.message-popup-partner').addClass('open'); }, 300);
        return false;
    });
    ...
    jQuery(".js-popup-close").on('click', function () {
        CRUMINA.toggleNav();
        setTimeout(function () { $('.search-popup').removeClass('open'); }, 400);
        setTimeout(function () { $('.message-popup-partner').removeClass('open'); }, 400);
        setTimeout(function () { $('.popup-gallery').removeClass('open'); }, 400);
        return false;
    });
