...
export class LiveclasssinglepageComponent implements OnInit, OnDestroy {
  ...
  constructor(public redirectionService: RedirectionService, @Inject(SESSION_STORAGE) private storage: WebStorageService,public router: Router, private sanitizer: DomSanitizer, private location: Location) {
