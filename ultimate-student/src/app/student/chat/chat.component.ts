...
export class ChatComponent implements OnInit {
  ...
  constructor(@Inject(SESSION_STORAGE) private storage: WebStorageService, private location: Location,private chatService : SocketIoService, protected serviceDashboard: DashboardApiHelper, private toastr: ToastrService) { }
