...
export class TopicApiHelper {
  ...
  getTopicList(): Observable<any> {
    ...
    return this.baseService.get(appApiResources.topic, headers).pipe(
  ...
  addTopic(topic: any): Observable<any> {
    ...
    return this.baseService.post(appApiResources.topic, topic, headers).pipe(
        map((res: Response) => res),
        catchError((error: HttpErrorResponse) => throwError(error.error))
      );
  }  
  ...
  updateTopic(topic: any): Observable<any> {
    ...
    return this.baseService.put(appApiResources.topic, topic, headers).pipe(
        map((res: Response) => res),
        catchError((error: HttpErrorResponse) => throwError(error.error))
      );
  }
  ...
  deleteTopic(topicId: number): Observable<any> {
    ...
    return this.baseService.deleted(appApiResources.topic+"/"+topicId, headers).pipe(
        map((res: Response) => res),
        catchError((error: HttpErrorResponse) => throwError(error.error))
      );
  }
